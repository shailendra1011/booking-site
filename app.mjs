...
// Set up CORS options
const corsOptions = {
  origin: [process.env.FRONTEND_URL, process.env.ADMIN_URL, 'http://localhost:5173', 'http://localhost:5173', 'http://65.0.232.150/travel-house-web/pick-up','http://65.0.232.150/travel-house-admin', 'https://preprod-article-api.iexp.in', 'https://preprod-site-cms.iexp.in', 'https://preprod-site-api.iexp.in', 'https://preprod-auto.iexp.in', 'https://preprod-telecom.iexp.in', /^https?:\/\/(?:.+\.)?financialexpress\.com$/], // Replace with your Next.js app's URL
